...
const Navbar: React.FC<NavbarProps> = ({ isDarkMode, setIsDarkMode }) => {
  ...
  return (
    <>
      ...
      {/* Navbar */}
      <nav
        className={` dark:bg-lightHover bg-black fixed w-full px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 transition-all duration-300 ${
          isScroll ? 'bg-black  backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20' : ''
        }`}
      >
        {/* Logo */}    
        <a href="#top">
