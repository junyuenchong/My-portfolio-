  ...
  return (
    <>
      ...
      >
        ...
        <ul
          ref={sideMenuRef}
          className="flex md:hidden flex-col gap-6 py-12 px-8 fixed top-0 right-0 w-64 max-h-[90vh] overflow-y-auto z-50 bg-white dark:bg-black transition-transform duration-500 translate-x-64 "
        >
